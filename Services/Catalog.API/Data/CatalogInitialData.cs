    ...
    private static IEnumerable<Product> GetPreconfiguredProducts()
    {
        return new List<Product>{
            ...
            new Product()
            {
                ...
                Price = 840.00M,
                Categories = new List<string> { "Smart Phone", "Camera" }
            },
            new Product()
            {
                ...
                Price = 650.00M,
                Categories = new List<string> { "White Appliances", "Smart Phone" }
            },
            new Product()
            {
                ...
                Price = 470.00M,
                Categories = new List<string> { "White Appliances", "Home Kitchen" }
            },
            new Product()
            {
